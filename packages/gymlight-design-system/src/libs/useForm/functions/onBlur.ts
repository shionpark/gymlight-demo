import { ValidateFieldType, FieldsType, RefTargetType } from "../types";
...
export const onBlur =
  ...
  ): React.FocusEventHandler<Element> =>
  (event) => {
    ...
    validateField(event.target as RefTargetType, validationRules);
  };
